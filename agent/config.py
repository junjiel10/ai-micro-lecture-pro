...
THEMES = {
    ...
    # 唯一一套浅色主题。前三套都是深色底，做「清新」这个方向时需要浅色：
    # 极浅的薄荷到天蓝渐变打底，正文用深墨绿保证对比度，卡片纯白。
    # accent 仍要够饱和，它同时充当标题竖条、进度条和 logo 底色。
    "mint": {
        "name": "薄荷青",
        "bg_top": (238, 251, 246), "bg_bottom": (222, 241, 250),
        "accent": (13, 168, 140), "accent2": (56, 152, 235),
        "text": (22, 54, 50), "muted": (98, 130, 126),
        "card": (255, 255, 255),
    },
}
